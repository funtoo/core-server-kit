...
SRC_URI="https://ftp.postgresql.org/pub/source/v13.18/postgresql-13.18.tar.bz2 -> postgresql-13.18.tar.bz2"

IUSE="debug doc icu kerberos ldap llvm  nls pam perl python +readline selinux +server ssl static-libs tcl uuid zlib"
